            ...
            <div id="wrapper">
                ...
                <table class="table table-striped">
                    ...
                    <form method="get" action="altaUsuario.jsp">
                        <tr>
                            <td><input type="text" name="Nombre" style="width: 150px;" ></td>
                            <td><input type="text" name="Usuario" style="width: 150px;" ></td>
                            ...
                            <td><button type="submit" value="Añadir" id="añadir"><span></span> Añadir</button></td><td></td></tr>           
                    </form>

                    <%
                      ResultSet anime2 = s.executeQuery("SELECT IDUS, Nombre, Usuario, Email, NOMAN FROM usuario u "
                    ...
                    <td>
                        <form method="get" action="modificaUsuario.jsp">
                            ...
                            <input type="hidden" name="anime" value="<%=anime2.getString("NOMAN")%>">
